...
const handleSubmit = async (event) => {
    ...
    try {
      ...
      // ✅ FIX: Check if the network response was "OK" (Status 200-299)
      if (response.ok) {
        if (state === "Sign Up") {
          ...
          // Login Success Logic
          // We use a fallback "demo-token" because our simple backend didn't generate a complex JWT token yet.
          login(result.token || "demo-token");
          ...
          // 🚀 This is the line that moves you to the Home Page!
          navigate("/"); 
        }
      } else {
